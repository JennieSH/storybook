...
export interface Meta<Args> extends Omit<BaseMeta<Args>, "argTypes">, Annotation<Args> {
  component: Component<Args> | AsyncComponent<Args>;
}
export interface Meta<Args> extends Omit<BaseMeta<Args>, "argTypes">, Annotation<Args> {
  component: Component<Args> | AsyncComponent<Args>;
}

export interface Story<Args> extends Annotation<Args>, Omit<BaseStory<Args>, "argTypes"> {
  (args: Args, context: StoryContext): StoryFnVueReturnType | StoryFnVueReturnType[];
}
...
type Control<T> = ControlArray | ControlBare | ControlColor | ControlEnum<T> | ControlNumber;
